      ...
      >
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-anac-border overflow-hidden">
          ...
          <div className="flex border-b border-anac-border">
            <StepTab
              active={step === 'login'}
              completed={step === 'set-password'}
              step={1}
              label="Connexion"
            />
            <div className="w-px bg-anac-border" />
            <StepTab
              active={step === 'set-password'}
              completed={false}
              step={2}
              label="Mot de passe"
            />
            ...
            <AnimatePresence mode="wait" custom={direction} initial={false}>
                ...
                >
                  ...
                  >
                    <FormField
                      id={employeeCodeId}
                      label="Matricule"
                      error={loginErrors.employeeCode?.message}
                    >
                      <Input
                        id={employeeCodeId}
                      ...
                      {firstLogin ? (
                        ...
                        >
                          <FormField
                            ...
                            label="Mot de passe"
                            error={
                              'password' in loginErrors
                                ? (loginErrors as { password?: { message?: string } }).password
                                    ?.message
                                : undefined
                            }
                          >
              ...
              {step === 'set-password' && (
                ...
                >
                  ...
                  <form
                    onSubmit={passwordForm.handleSubmit(onSetPasswordSubmit)}
                    className="space-y-4"
                    noValidate
                  >
                    <FormField
                    ...
                    >
                      <div className="relative">
                        <Input
                          ...
                          autoComplete="new-password"
                          className={cn(
                            errCls(!!passwordForm.formState.errors.confirmation),
                            'pr-10'
                          )}
                        />

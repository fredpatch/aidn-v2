...
CREATE TYPE "public"."document_owner_type" AS ENUM('dg_circuit_document', 'formal_request_document', 'preliminary_evaluation_form', 'payment_invoice', 'payment_proof');--> statement-breakpoint

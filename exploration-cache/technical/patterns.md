...
These aren't code patterns so much as _table_ patterns reused by multiple business
...
When adding a new phase module, check whether it needs a _new_ table or can just add
